...
* Sunday you check the course website and schedule to note important due dates and to plan your week accordingly. 
* Before Monday noon you complete your individual quiz through Google forms, and perhaps watch one of the lecture videos or do some reading on that week's topic. 
* Monday class: ~20 min group quiz, ~20 min lecture on topic for the week, ~35 min actively working on homework
* Before Wednesday class you complete the assigned reading, watch lecture videos, and prepare answers to the discussion questions
* Wednesday class: ~20 min questions/discussion, ~55 min actively working on homework
* Before Thursday EOD you submit your draft assignment to google drive.
* Between Friday & Saturday noon you provide feedback on 1-2 of your classmates assignments and continue to work on your own assignment using. 
...
* The approximate contributions per category are:  
  - Participation 15%: Peer reviews  
  - Written Assignments 25%: Submitted in Google Drive, graded using a rubric in Blackboard Learn.  
  - Weekly Quizzes 25%: Google Forms. 
  - Take home Final exam: 10%
  - Project related assignments:  25%  
