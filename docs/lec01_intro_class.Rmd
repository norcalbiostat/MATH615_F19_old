...
* Textbook used for reading and learning content, and some problem sets. 
...
* I prefer R for teaching for many reasons, but mostly for ease of turning in nicely formatted homework without copy/pasting
* All my lecture notes use R. This entire website is built with R. 
...
* You will "publicly" share your analysis steps and thought process. 
    ...
    - For those gung-ho R users I *highly* recommend building your blog using [`blogdown`](https://bookdown.org/yihui/blogdown/)
        - Talk with me if you want to do this. 
...
And the best place to learn new nifty things and see cool analyses done in R: https://www.r-bloggers.com/
