...
## In class
* Discuss how to choose appropriate graphics based on data types. 
* Discuss how to interpret and describe distributions of data. 
* **Time pending**: Reproduce all univariate graphics and tables in your SPC. 
...
* Univariate graphing assignment. [[Instructions]](hw/Univ_Graphing.html)
    - [[Example assignment]](docs/Univariate Graphing Assignment Examples.pdf) from another class done in SAS. 
    - Note that their instructions were to put all the code at the end.
    - I want to see the relevant code next to the plot itself. Don't make me hunt for it!
