...
* Get textbook
* Class webpage bookmarked
* Go to Hack MD (link above), read the introduction and add your name/major
* Slack account made
    - Desktop / phone app installed
    - Introduction posted in #introductions channel
* Star the class google drive folder so it's easier to find
* Class working directory setup 
