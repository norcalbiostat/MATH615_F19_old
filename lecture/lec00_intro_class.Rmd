...
* Look at one [diagram](https://osf.io/69gub/wiki/home/) of the `tidyverse` (a suite of functions in R). Compare it to the images of the data analysis life cycle. What sense do you get? 
...
* My [instructions](https://norcalbiostat.netlify.com/post/software-overview/) on how to get setup with necessary programs. 
* On campus resources
