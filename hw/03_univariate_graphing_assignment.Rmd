...
* Use the template provided: [[RMD]](univariate_graphing_template.Rmd) for R users, and [[Word]](univariate_graphing_template.docx) for SPSS users. Rename this file to `univ_graphing_userid`
