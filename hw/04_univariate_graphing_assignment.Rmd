...
* Use the template provided: [[RMD]](03_univariate_graphing_template.Rmd) for R users, and [[Word]](03_univariate_graphing_template.docx) for SPSS users. Rename this file to `univ_graphing_userid`
...
* Upload your final PDF to `03 Univariate Graphing` folder in Google Drive with the file name: `univ_graphing_userid.pdf`
