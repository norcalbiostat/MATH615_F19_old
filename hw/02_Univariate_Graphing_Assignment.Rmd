...
0. Use the template provided: [[RMD]](Univariate_Graphing_template.Rmd) for R users, and [[Word]](Univariate_Graphing_template.docx) for SPSS users. Rename this file to `univ_graphing_userid`
...
##### Submission
* Upload the final PDF to `Incoming/02 Univariate Graphing` folder in Google Drive with the file name: `univ_graphing_userid.pdf`
