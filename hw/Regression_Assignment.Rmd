...
The p-value for the regression coefficient estimte of `eversmoke_c` is still significant at <.0001 after controlling for gender. Thus gender is **not** a confounder. 


## 5. Interpret the Results

Create a table containing the odds ratio estimates and 95% CI for those estimates using the confounding model. You will see one of three things: 
...
# Log Linear Regression (Not complete yet as of 11/1/17)
