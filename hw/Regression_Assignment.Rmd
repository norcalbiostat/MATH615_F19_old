...
You will then take one of the three above analyses (or a new model) and 
...
* Use the template provided: [[RMD]](Regression_template.Rmd) for R users, and [[Word]](Regression_template.docx) for SPSS users. 
