...
2. State the research Hypothesis
    - Write out the Null, Alternative, and confounding Hypothesis
    - The statement for the confounding hypothesis is the same as the alternative hypothesis, except it will include the phrasing of “after controlling for ‘Third Variable’.” 
3. Fit two models
...
The relationship between income and wake up time is still significant. Gender is not a confounder. 
