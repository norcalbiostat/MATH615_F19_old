...
You will perform <span style="color:blue">4</span> regression analyses in this assignment. For each you will interpret the regression coefficients, and test for a potential confounder $Z$.
