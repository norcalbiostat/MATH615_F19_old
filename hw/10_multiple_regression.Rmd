...
Worked out examples are available as [[HTML]](10_multiple_regression_examples.html) or [[PDF]](10_multiple_regression_examples.pdf)

# Instructions

0. Use the template provided: [[RMD]](10_multiple_regression_template.Rmd) for R users, and [[Word]](10_multiple_regression_template.docx) for SPSS users. 
...
```{r, results='asis'}
library(stargazer) # alternative package for printing regression results nicely
stargazer(lm.mod1, lm.mod2,  type='html', ci=TRUE, single.row=TRUE, digits=2)
```
