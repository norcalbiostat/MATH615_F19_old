...
* Either create a Word doc or write your paper directly in Google Docs. **Do not convert to PDF this time.**
* Upload your final version to the `Research Proposal` folder in Google Drive with the file name: `proposal_userid`
* Submit a copy of this paper to Blackboard for grading via rubric. 
