...
For each article, you will complete steps 1-3, in other words 4 times. Then complete the remaining steps. [Example submission](../docs/Citation Assignment Example.pdf)
