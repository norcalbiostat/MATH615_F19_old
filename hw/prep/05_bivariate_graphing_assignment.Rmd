...
0. Use the template provided: [[RMD]](05_bivariate_graphing_template.Rmd) for R users, and [[Word]](05_bivariate_graphing_template.docx) for SPSS users. 
...
5. Upload your assignment as a PDF to the **05 Bivariate Graphics** folder in Google Drive. Use the file name: _biv_graph_userid.pdf_
