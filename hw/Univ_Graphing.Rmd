...
3. Complete describe at least 2 of your quantitative variables. 
    - If you DO NOT have truly quantitative variables, then consider if the quantitative variable age or some other quantitative variable(s) would be a variable(s) to include. If not, then you need to do additional categorical variables. Do as many quantitative variables as you have and then to bring that total to 5, do however many categorical variables (as bar charts) you need to bring the total number of graphs to 10.
...
* WORD for SPSS users, HTML for R users. 
    - SPSS users - paste your entire code at the bottom of the document
