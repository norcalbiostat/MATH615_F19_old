...
Time to start organizing your poster. We will do this in stages by building a "powerpoint" type presentation. This will help you concicely explain your research topic and findings in a way that you can more easily translate (fit) onto a poster. 

## Instructions
* Create a Google Slides presentation directly in the MATH 615 Google Drive.
* Name it using first_last name only. 
* The required contents for each slide are listed below. 
