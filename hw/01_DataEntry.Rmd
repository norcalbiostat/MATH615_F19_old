...
* You will create these in Excel, a popular spreadsheet program for data collection and entry. 
* Save this excel file in your `MATH615\data` folder as `medical_records.xlsx`. 
...
## Submission
Upload your excel file to Google Drive by the due date listed on the class calendar. 
