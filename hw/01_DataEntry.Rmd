...
* You will create these as either an Excel spreadsheet or directly in Google sheets. 
    - If you use Google Sheets place your file in the [`01 Data Entry`](https://drive.google.com/open?id=1-yguQAv0SH6RoZJLlvmO4wojWd6U4Tlh) folder. 
...
1. Using your software program of choice, import this data into the program using point and click GUI methods.
    - If you used Google Sheets you should save your file as either `.csv` or `.xlsx` into your `MATH615\data` folder. 
...
## Submission
Upload your Excel file to Google Drive (`01 Data Entry` folder) by the due date listed on the class schedule. 
