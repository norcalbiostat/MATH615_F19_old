...
## Lecture Notes
The General set of notes that span multiple topics from 315, 615 and 456.  [Applied Statistics Notebook](https://norcalbiostat.github.io/AppliedStatistics_notes/index.html). Abbreviated as **AS Notebook**
```{r, message=FALSE, warning=FALSE, echo=FALSE}
