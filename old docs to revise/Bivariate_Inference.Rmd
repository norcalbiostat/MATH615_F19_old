...
When we want to assess if there is an association between two variables we conduct a **bivariate analysis**. 

The data types of the variables under consideration will determine what statistical analysis will be used. Below is a list of the possible combinations of data types and the appropriate bivariate analysis method. 
...
Each of the following sections presents some information about the analysis, along with an example. 
...
* Assumes the quantitative variable has an approximately normal distribution
