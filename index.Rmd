...
### `r format(wk1.date+6*7, "%m-%d-%Y")` Week 7: Quantifying Uncertainty, Foundations for Inference

As we start our next phase of the class working on conducting _Inferential Statistics_, we need to finish learning how to correctly interpret a confidence interval, and some fundamentals regarding hypothesis testing. 
...
* We're still working out of [OpenIntro Statistics textbook Ch5](https://leanpub.com/openintro-statistics) or Dr. D's [Math 315 course notes Ch4](https://norcalbiostat.github.io/MATH315/reading/RAD_course_notes_f19.pdf) 

**Thursday 10/10**

* Group quiz on interval estimation
* Start Homework 08, analyzing bivariate relationships. This can/will build directly off HW 05.   
* Two sample T-test for a difference in means (Q ~ B)
