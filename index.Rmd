...
* Outlook on Life Survey. 
    - Supplemental Info for Final Exam [[OFFICIAL]](FinalDocs/FinalExam_Fall17_Supplemental.pdf). This document consists of a summary of the survey, data management, univariate descriptions for variables used, and a few pages of analysis. 
...
* Additional information, such as full wording of the question on how the variables were coded can be found in the [[codebook](FinalDocs/OOL Codebook.pdf) and [[survey questionnaire]](FinalDocs/OOL Questionnaire.pdf), both are linked below. 
