...
**Prerequisites:** Basic computer literacy. Recent statistics course such as Math 105, MATH 315, MATH 350 or MATH 305.  
**Meeting Days and Times** Tue/Thu 11-12:15, HOLT 155

You can download the Syllabus in PDF form by clicking [this link](../docs/Syllabus.pdf).


## Required Materials

* **Textbook**: _Practical Multivariate Analysis, 5th ed_ by Afifi, May Clark, [Amazon](https://www.amazon.com/Practical-Multivariate-Analysis-Chapman-Statistical/dp/1439816808) [CRC Press](https://www.crcpress.com/Practical-Multivariate-Analysis-Fifth-Edition/Afifi-Afifi-May-May-Donatello-Clark-Clark/p/book/9781439816806) _Note: I am **not** an author of the 5th edition._
...
* **Google Apps:** We will use Google Docs/Drive/Forms occassionally throughout the class. All use of Gdrive items require you to log in using your campus @mail.csuchico.edu email account. 
...
A more detailed schedule that is updated weekly can be found [here](). The general ordering of topics is:

* Data Collection and recording
* Preparing data for analysis
* Data Visualization
* Experimental Design & Selecting appropriate analyses
