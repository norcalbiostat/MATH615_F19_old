...
The final exam will revolve around two items: The Outlook on Life Survey and a paper on smoking behavior in youth exposed to the child welfare system. 

* Outlook on Life Survey. 
    - Supplemental Info for Final Exam [[SAMPLE](FinalDocs/FinalExam_Fall17_Supplemental_Sample.pdf). This document consists of a summary of the survey, data management, univariate descriptions for variables used, and a few pages of analysis. 
...
* Additional information, such as full wording of the question on how the variables were coded can be found in the [[codebook](FinalDocs/OOL Codebook.pdf) and [[survey questionnaire]](FinalDocs/OOL Questionnaire.pdf), both are linked below. **Do not bring these to the final**. They are for you to use as referece material while you are learning to understand this survey.   
