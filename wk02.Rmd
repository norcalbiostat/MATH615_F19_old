...
* Review the notes on doing data management [[HTML]](docs/lec02_doing_dm.html), [[PDF]](docs/lec02_doing_dm.pdf) 
...
* Blog about some issues you are going to have to deal with during data management. Name variables specifically. 
    ...
    - Use the data management preparation questions as a guide for your thoughts. 
