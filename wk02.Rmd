...
## Prepare
* Read the data management preparation [[HTML]](hw/dm_assignment_preparation.html) or [[PDF]](hw/dm_assignment_preparation.pdf) notes. 
* Read the `depression` data set into your SPC
...
* Data management and cleaning in a reproducible manner. 
    ...
    - R users will create a new `.RMD` file. 
    - SPSS users should create a new `.txt` file. Windows uses Notepad, Mac uses TextEdit.
...
* Start a **dm** file for Add Health. 
...
##### Assignments
* Blog about some issues you are going to have to deal with during data management. Name variables specifically. 
    - Check a few of your classmates blogs about this. Chances are you will be doing similar approaches on different variables. 
...
* Read: Literature review notes [[HTML]](docs/lec_lit_review.html) [[PDF]](docs/lec_lit_review.pdf)

## In class
* Brief discussion of literature review
