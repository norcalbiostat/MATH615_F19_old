...
* Review the [data prep notes](docs/lec02_data_prep.html) 
    - Consider starting to replicate the code in these notes in your SPC. 
...
##### Assignments
* Personal Codebook / Research Question Assignment (Due 8/31)
...
* Start a data management file for the Add Health data. You wil submit this to BBLearn by **9/4**
...
* Citation assignment (**Due 9/7**) [[Instructions]](hw/Citation_Assignment.html)
