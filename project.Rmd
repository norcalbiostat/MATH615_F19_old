...
Throughout the entire semester you will be analyzing a data set with the end goal of creating a poster presentation and creat Much of your homework will include analysis of your 

Your homework serves as a first draft of exploration into your research questions, and helps you build your story. Homework assignments alone will not be sufficient for a good analysis. 
...
### Instructions
* Create a Google Slides presentation directly into the [Projects](https://drive.google.com/open?id=0B83Z8_sNw3KPUWFRdXo3WUdiNUk) Google Drive Folder. 
  - This folder is shared with MATH 315 as well. They are doing a similar project. It will help them to see the quality of your writing and effort. 
