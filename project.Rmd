...
### Instructions
* Create a Google Slides presentation directly into a [Add Health Posters](https://drive.google.com/open?id=0B83Z8_sNw3KPUWFRdXo3WUdiNUk) Google Drive Folder. 
  - This folder is shared with MATH 315 as well. They are doing the same project. It will help them to see the quality of your writing and effort. 
...
These should follow well from your research proposal. Here is the link to the post on [writing empirical research](https://norcalbiostat.netlify.com/lec/lec_writing_em/). 
...
7. Description of measures (variables) being used. Explain any recoding and/or altering that was done - but only for recodes more substantial than setting values to missing. 
...
Refer to the [Bivariate Inference](docs/Bivariate_Inference.html) assignment on how to conduct and interpret these bivariate analyses.

#### <span style="color:blue">**Stage 3 (In progress)**</span>
